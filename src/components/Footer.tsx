...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#1A1815] text-white border-t border-[#3A3835]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white/60 hover:text-[#D26A3B] transition-colors duration-300">
              ...
              {['Home', 'About', 'Gallery', 'Amenities', 'Location', 'Contact'].map((item) => (
                <li key={item}>
                  <a 
                    ...
                    className="text-white/80 hover:text-[#D26A3B] transition-colors duration-300"
                  >
                    {item}
                  </a>
                </li>
